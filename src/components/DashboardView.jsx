  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-content">
        ...
        <DasCompo value="15" label="New Users" icon="fa-users" className="green" reff='https://www.figma.com/design/KclT8XSx6rr3eGRl6pzNjl/AdminLTE-Admin-dasboard-UI-Kit-v3-(Community)?node-id=1-5425&t=qon163pq6CXVjeOK-0' />
